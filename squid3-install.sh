...
# Function to ensure the necessary scripts are available
...
# Function to uninstall Squid if already installed
uninstall_squid() {
    if [[ -d /etc/squid/ ]]; then
...
# Download the necessary scripts before proceeding with installation
download_supporting_scripts
